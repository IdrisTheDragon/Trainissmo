...
function Public.create_wagon_room(icw, wagon)
    ...
    if wagon.entity.type == 'cargo-wagon' then
        local multiple_chests = true
        local cargo_wagon = area
        ...
        if multiple_chests then
                ...
                local left = surface.create_entity(
                    {
                        ...
                        position = {position1[1] - pos, position1[2]},
                        force = 'neutral',
                        create_build_effect_smoke = false
                    }
                )
                left.destructible = false
                left.minable = false

                local loader =  surface.create_entity(
                    {
                        name = 'express-loader',
                        position = {position1[1] - pos, position1[2]+2},
                        force = 'neutral',
                        create_build_effect_smoke = false
                    }
                )
                ...
                local right = surface.create_entity(
                    {
                        ...
                        position = {position2[1] + pos, position2[2]},
                        force = 'neutral',
                        create_build_effect_smoke = false
                    }
                )
                right.destructible = false
                right.minable = false

                local loader_1 =  surface.create_entity(
                    {
                        name = 'express-loader',
                        position = {position2[1] + pos, position2[2]+2},
                        force = 'neutral',
                        create_build_effect_smoke = false
                    }
                )
                loader_1.destructible = false
                loader_1.minable = false

                wagon.transfer_entities = {left, right}
            end
            ...
            for pos = 0, 2, 1 do
                ...
                local left = surface.create_entity(
                    {
                        name = 'logistic-chest-requester',
                        position = {position3[1] - pos, position3[2]},
                        force = 'neutral',
                        create_build_effect_smoke = false
                    }
                )
                ...
                local loader =  surface.create_entity(
                    {
                        name = 'express-loader',
                        position = {position3[1] - pos, position3[2]-1},
                        force = 'neutral',
                ...
                local right = surface.create_entity(
                    {
                        name = 'logistic-chest-passive-provider',
                        position = {position4[1] + pos, position4[2]},
                        force = 'neutral',
                        create_build_effect_smoke = false
                    }
                )
                ...
                local loader_1 =  surface.create_entity(
                    {
                        name = 'express-loader',
                        position = {position4[1] + pos, position4[2]-1},
                        force = 'neutral',
                        direction = defines.direction.south,
                        create_build_effect_smoke = false
                    }
